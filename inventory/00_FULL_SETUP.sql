...
-- 08: Service Jobs
-- ============================================================
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'ServiceJobs' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
...
IF NOT EXISTS (SELECT 1 FROM sys.tables WHERE name = 'ServiceJobMaterials' AND schema_id = SCHEMA_ID('dbo'))
BEGIN
...
PRINT N'[setup] ServiceJobs + ServiceJobMaterials tables created.';
GO
